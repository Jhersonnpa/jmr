  ...
  return (
    <div className="w-full h-full">
      {items.length >= 1 ? (
        ...
        <div className="md:w-3/4 lg:w-1/2 rounded-md h-full p-5 md:pb-10 mx-auto flex justify-center items-center flex-col gap-4 bg-white/30 dark:bg-white/10 backdrop-blur-xl shadow-2xl">
          <div>
            <img
              src="/error.gif"
              alt="error gif"
          ...
          <p className="font-bold dark:text-white text-sm md:text-lg lg:text-xl text-pretty">
            No se ha encontrado el recurso:
          </p>
          <p className="font-semibold text-sm md:text-lg lg:text-xl dark:text-white">
            ' <span>{$buscador}</span> '
          </p>
        </div>
      )}
