...
const SearchContent = () => {
  ...
  return (
    <div className="w-full h-full">
      {items.length >= 1 ? (
        <div className="w-full h-full grid gap-4 grid-cols-1 sm:grid-cols-2 auto-cols-fr lg:grid-cols-4">
          {items.map((item, i) => (
            <div
              key={i}
        ...
        <div className="w-1/2 rounded-md h-full p-20 mx-auto flex justify-center items-center flex-col gap-4 bg-white/30 dark:bg-white/10 backdrop-blur-xl shadow-2xl">
          <div>
            <img src="/error.gif" alt="error gif" className="w-1/2 object-contain mx-auto"/>
            {/* <svg
              xmlns="http://www.w3.org/2000/svg"
              className="icon icon-tabler icon-tabler-device-desktop-x h-24 w-24"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              strokeWidth="2"
          ...
          <p className="font-bold dark:text-white text-3xl text-pretty">No se ha encontrado el recurso:</p>
